...
|xref:runtime-manager-2.adoc#runtime-mgr-application-deploy[runtime-mgr application deploy]|Deploys an application to a specified target using an Exchange application and runs the specified runtime version
...
|xref:runtime-manager-2.adoc#runtime-mgr-application-download-logs[runtime-mgr application download-logs]|Downloads logs of an application from a specification to a specified directory
...
|xref:runtime-manager-2.adoc#runtime-mgr-application-tail-logs[runtime-mgr application tail-logs]|Tails an application's logs from a specification
