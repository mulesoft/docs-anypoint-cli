...
|===
|Command |Description
|xref:project.adoc#project-validate[project validate]  | Validates API projects independently of Exchange and Design Center. Uses the descriptor information in `exchange.json` files if present to identify project and dependency information. 
|===
