...
|===
|Command |Description
|xref:cloudhub-2.adoc#acruntime-mgr-cloudhub2-application-list[runtime-mgr cloudhub2-application list]| Lists all applications in an organization
|xref:cloudhub-2.adoc#runtime-mgr-cloudhub2-application-describe[runtime-mgr cloudhub2-application describe]| Describes an application
|xref:cloudhub-2.adoc#runtime-mgr-cloudhub2-application-describe-json[runtime-mgr cloudhub2-application describe-json]| Describes an application in raw JSON response
