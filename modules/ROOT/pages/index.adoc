...
For information about generating a bearer token, see https://help.salesforce.com/s/articleView?id=001115323&type=1[How to generate your Authorization Bearer token for Anypoint Platform].
...
|===
|Parameter |Description
| `organization` | Your organization or sub-organization (business group) within Anypoint Platform. You can specify the root organization name or the name of a specific business group.
