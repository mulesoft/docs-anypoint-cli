...
Run the following command to install Anypoint CLI package. Depending on the configuration of your system, you might need to run this command using administrator credentials.
