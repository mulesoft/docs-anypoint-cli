...
* <<single-signon,Using single sign-on (SSO)>>
...
If you are not using SSO, pass credentials to your Anypoint Platform CLI installation using the credentials configuration file.  
