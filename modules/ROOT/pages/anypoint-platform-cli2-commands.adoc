...
Further configuration information can be found in the xref:runtime-manager::cloudhub-dedicated-load-balancer.adoc#managing-certificates[certificates section] of the dedicated xref:runtime-manager::cloudhub-dedicated-load-balancer.adoc[load balancer documentation] page.
