...
* If you do not pass a command-line parameter, the default profile properties are used.
...
You can use command autocompletion with Anypoint CLI commands. To use autocompletion:

* Start typing the name of the command or parameter and press Tab for autocomplete or press Tab+Tab for a list of options.
