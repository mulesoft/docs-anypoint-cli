...
|--[no-]staticIPsEnabled                                      | Enable or disable static IPs. This value is `enabled` by default.
|--[no-]objectStoreV1                   | Enable or disable Object Store V1. This value is `disabled` by default.
|--[no-]objectStoreV2                   | Enable or disable Object Store V2. This value is `enabled` by default.
