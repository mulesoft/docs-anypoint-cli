...
|xref:xref:cloudhub-apps.adoc#runtime-mgr-cloudhub-application-describe[runtime-mgr:cloudhub:application:describe] | Shows application details
// |<<runtime-mgr-cloudhub-application-describe-json>> | Show raw application JSON response
|xref:cloudhub-apps.adoc#runtime-mgr-cloudhub-application-stop[runtime-mgr:cloudhub:application:stop] | Stops a running application
|xref:cloudhub-apps.adoc#runtime-mgr-cloudhub-application-start[runtime-mgr:cloudhub:application:start] | Starts an application
|xref:cloudhub-apps.adoc#runtime-mgr-cloudhub-application-restart[runtime-mgr:cloudhub:application:restart] | Restarts a running application
|xref:cloudhub-apps.adoc#runtime-mgr-cloudhub-application-delete[runtime-mgr:cloudhub:application:delete]| Deletes an application
|xref:cloudhub-apps.adoc#deploy-to-cloudhub[runtime-mgr:cloudhub:application:deploy] | Deploys a new application
|xref:cloudhub-apps.adoc#runtime-mgr-cloudhub-application-modify[runtime-mgr:cloudhub:application:modify]| Modifies an existing application, optionally updating the ZIP file
