...
|`--secureProperty` | Sets an encrypted property. | `--secureProperty camtest2:3 d1519c7b-16ac-45f3-a771-5bcdcf23dda4`
...
Default: `0.1` | `--replicaSize 0.5`
|`--runtimeVersion` |Runtime version of the deployment target.|`--runtimeVersion 4.4.0`
|`--secureProperty` | Sets an encripted property. | `--secureProperty camtest2:3 d1519c7b-16ac-45f3-a771-5bcdcf23dda4`
|`--scopeLoggingConfig`| Defines scope logging. +
