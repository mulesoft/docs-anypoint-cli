...
Only UBP organizations can use this flag. Non-UBP organizations use the `--replicaSize` flag | `--instanceType mule.micro`
...
|`--instanceType` | Instance type +
Only UBP organizations can use this flag. Non-UBP organizations use the `--replicaSize` flag | `--instanceType mule.nano`
|`--[no-]lastMileSecurity`| Enables Last Mile Security. +
Default: `disabled` | `--no-lastMileSecurity`
|`--[no-]objectStoreV2`| Enables object store v2. +
Default: `disabled`  | `--no-objectStoreV2`
