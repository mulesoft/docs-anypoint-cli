...
|===
|Command |Description
|xref:anypoint-cli::api-catalog.adoc#autocomplete-command[api-catalog autocomplete] | Configures autocompletion for API Catalog commands
|xref:anypoint-cli::api-catalog.adoc#conf-command[api-catalog conf] | Creates or deletes a credentials configuration file
|xref:anypoint-cli::api-catalog.adoc#create-descriptor-command[api-catalog create-descriptor] | Creates a descriptor file
|xref:anypoint-cli::api-catalog.adoc#update-descriptor-command[api-catalog update-descriptor]  | Updates a descriptor file
|xref:anypoint-cli::api-catalog.adoc#publish-asset-command[api-catalog publish-asset] | Publishes assets to Exchange
|===
