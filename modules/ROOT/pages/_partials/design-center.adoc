...
Use the `--resolveDependenciesTimeout=X` flag to specify the duration, in minutes, for which the system should await the resolution of dependencies before downloading a project. Adjust the value of X according to your desired duration.
