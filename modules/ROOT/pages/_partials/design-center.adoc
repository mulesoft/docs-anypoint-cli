...
| `--version` |The OAS Specification version. This flag is only available for OAS APIs. +
Supported values: `2.0`, `3.0` | `--version 2.0`
| `--format` | The OAS Specification format. This flag is only available for OAS APIs. +
...
| `--assetId`  | The asset assetId | `designcenter:project:publish --assetId project`
| `--groupId` | The asset groupId | `designcenter:project:publish --groupId com.mulesoft.com`
| `--main` | The name of the main file name | `--main sample.xml`
| `--name` | The name for the asset | `--name sampleProject`
| `--status` | The asset status +
Supported values are: `development` and `published` (default) | `designcenter:project:publish --version 1.0`
| `--tags` | Comma separated list of tags | `--tags test,sample,integration`
| `--version` | The asset version | `designcenter:project:publish --version 1.0`
|===
