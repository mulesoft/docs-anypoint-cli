...
Supported values are: `id`, `name`, `createdDate`, and `updatedDate`| `api-mgr alert list --sort updatedDate`
|===
...
| `--sort` +
Supported values are: `id`, `name`, `createdDate`, and `updatedDate`| Sorts the results in the field name passed
|===
...
|`--sort` | Sorts the results in the field name passed +
Supported values are: `id`, `name`, `createdDate`, and `updatedDate`| `api-mgr contract list --sort createdDate`
|===
...
|`--sort` | Sorts the results in the field name passed +
Supported values are: `id`, `name`, `createdDate`, and `updatedDate` | `api-mgr tier list --sort id`
|===
