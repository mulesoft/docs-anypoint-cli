...
Besides the default `--help` flag and the xref:api-catalog.adoc#common-options[general and authentication flags], this command also accepts:
...
include::api-catalog.adoc[tags=common-options]