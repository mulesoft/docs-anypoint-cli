...
You cannot create secret groups with CLI, but you can apply already created secret groups.

| `--inboundTlsContextId <value>` 
| Outbound TLS Context ID. +
You must supply the `--inboundSecretGroupId` of the TLS Context's secret group. You cannot create TLS Contexts with CLI, but you can apply already created TLS Contexts.
...
| Outbound TLS Context ID. +
You must supply the `--outboundSecretGroupId` of the TLS Context's secret group. You cannot create TLS Contexts with CLI, but you can apply already created TLS Contexts.
