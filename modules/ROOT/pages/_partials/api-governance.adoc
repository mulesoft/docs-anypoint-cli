...
|xref:api-governance.adoc#governance-api-inspect[governance:api:inspect]| Inspects an API specification and lists its schemas
|xref:api-governance.adoc#governance-api-validate[governance:api:validate]| Validates an API specification against a specified governance ruleset
