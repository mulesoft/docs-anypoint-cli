...
<3> Ruleset to which this set of issues applies 
<4> Severity level for the issue
<5> Description of the issue
<6> Node in AMF 
<7> Beginning line number and offset and end line number and offset in the API definition where the issue occurs
