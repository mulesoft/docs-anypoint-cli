...
| xref:api-governance.adoc#governance-project-validate
[governance project validate] | Validates an API project using the `exchange.json` file to identify dependencies and rulesets
...
// tag::governance-project-validate[]

[[governance-project-validate]]
== governance project validate

`> governance project validate <api-project>`

This command references the `exchange.json` file to download all project dependencies for a project and then runs the validation for the API. It also runs ruleset validations if there are any in the `exchange.json` file.
...
`anypoint-cli governance project validate --project /mypath/myproject.yml`

*Example output for a valid API:*

----
 xxx
----

*Example output for a nonvalid API:*

----
 xxx
----

// end::governance-project-validate[]
