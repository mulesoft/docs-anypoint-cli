...
|Flag |Description
|`--api=<api>`
|The API project against which you want to evaluate. The command uses the ruleset dependencies in the project's `exchange.json` file as criteria.
...
----
Ruleset User/myuser/temp/myruleset.yaml
Ruleset conforms with Dialect
----
