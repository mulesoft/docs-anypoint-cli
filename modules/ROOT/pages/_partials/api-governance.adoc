...
You can use one the notify options to configure notifications for the profile you are creating. If you do not use a notify option, no notifications are configured by the command.  
