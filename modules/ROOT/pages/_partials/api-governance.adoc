...
* The following example command validates using the rulesets in the `exchange.json` file in the zipped folder `order-api-1.0.0-raml.zip`. It validates the APIs found in the zipped folder `order-api-1.0.0-raml.zip` in the `~/Downloads/` directory path.
+
[source,copy]
----
...
----
+
* The following example command validates using the rulesets and APIs found in the folder `order-api-1.0.0-raml` in the `~/Downloads/` directory path.
+
[source,copy]
----
...
----
+
* The following example command validates using the rulesets listed with the `--rulesets` flag and any listed in the `exchange.json` file in the zipped folder named `order-api-1.0.0-raml.zip`. It validates the APIs found in the zipped folder  `order-api-1.0.0-raml.zip` in the `~/Downloads/` directory path.
+
[source,copy]
----
...
----
+
* The following example command validates using the remote ruleset specified using the ruleset identifier (GAV) and any rulesets listed in the `exchange.json` file in the zipped folder named `order-api-1.0.0-raml.zip`. It validates the APIs found in the zipped folder `order-api-1.0.0-raml.zip` in the `~/Downloads/` directory path.
+
[source,copy]
----
