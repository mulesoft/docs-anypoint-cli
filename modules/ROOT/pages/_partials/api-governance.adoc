...
|===
|Command |Description
| xref:api-governance.adoc#governance-api-evaluate[governance api evaluate] | Evaluates either filter criteria or an API project to determine which rulesets would be applied to this API for given filters
