...
* Validates using the rulesets and APIs defined in the `exchange.json` file in the zipped folder named `order-api-1.0.0-raml.zip`.
+
[source,copy]
----
...
----
+
* Validates using the rulesets and APIs defined in the `exchange.json` file in the folder named `order-api-1.0.0-raml`.
+
[source,copy]
----
...
----
+
* Validates using the rulesets listed with the --rulesets flag and any listed in the `exchange.json` file in the zipped folder named `order-api-1.0.0-raml.zip`. It validates the APIs defined in the `exchange.json` file in the zipped folder named `order-api-1.0.0-raml.zip`.
+
[source,copy]
----
...
----
+
* Validates using the remote ruleset specified using the ruleset identifier (GAV) and any rulesets listed in the `exchange.json` file in the zipped folder named `order-api-1.0.0-raml.zip`. It validates the APIs defined in the `exchange.json` file in the zipped folder named `order-api-1.0.0-raml.zip`.
+
[source,copy]
----
...
----
+
* Validates using the remote ruleset specified using the ruleset identifier (GAV) and any rulesets listed in the `exchange.json` file in the zipped folder named `order-api-1.0.0-raml.zip`. It validates the remote API specified using the API identifier (GAV).
+
[source,copy]
----
