...
[source,copy]
----
anypoint-cli governance api evaluate ~/Downloads/order-api-1.0.0-raml.zip
----

*Example output:*

----
This API's exchange.json has the following tags: <list of tags from exchange.json> and categories: (...) and if published, would be targeted by the following rulesets:
- <ruleset_1>
- <ruleset_2>
- (...)
----
