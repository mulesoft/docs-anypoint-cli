...
anypoint-cli governance api validate /MyRulesets/ruleset1.yaml,/MyRulesets/ruleset2.yaml  ~/Downloads/order-api-1.0.0-raml.zip
----
...
Specify the file location and file name of the ruleset definition YAML file that you want to validate or a ZIP file of a project that includes ruleset files to validate.	
