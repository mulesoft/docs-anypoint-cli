...
|  xref:datagraph-source.adoc#datagraph-validate[datagraph:validate]  | Validates an API source for the unified schema
|===
...
In addition to the default `--help` option, this command also accepts:
