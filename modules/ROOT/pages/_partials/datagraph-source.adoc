...
In addition to the default `--help`, `-f/--fields`, and `--verbose` options, this command accepts the following options:
...
This command takes the default `--help`, `-f/--fields`, and `--verbose` options.
