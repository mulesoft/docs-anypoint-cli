...
Note: the file of the specified "mainFile" property should be contained in the uploaded zip file. It should be on the root path, it can not be on a subfolder.
