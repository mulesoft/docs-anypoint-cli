...
|xref:cloudhub-dlb.adoc#cloudhub-load-balancer-describe[cloudhub:load-balancer:describe] | Shows load balancer details
...
|xref:cloudhub-dlb.adoc#cloudhub-load-balancer-ssl-endpoint-describe[cloudhub:load-balancer:ssl-endpoint:describe] | Shows the load balancer configuration for a particular certificate
