...
|`--transportDownstreamProtocols`  | TLS version used for communication between customer and DLB. Supported values are TLSv1.2 and TLSv1.3| `--transportDownstreamProtocols=TLSv1.2`
|`--transportUpstreamProtocols`  | TLS version used for communication between DLB and Mule worker. Supported values are TLSv1.2 and TLSv1.3| `--transportUpstreamProtocols=TLSv1.2`
