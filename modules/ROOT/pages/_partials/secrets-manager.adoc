...
|xref:anypoint-cli::secrets-manager.adoc#secret-shared-modify[secrets-mgr:shared-secret:modify]| Modifies a secret
...
Prompt the `--downloadable` flag if you want this group to be downloadable by members of your organization.
...
----
> secrets-mgr:secret-group:delete [flags] <id>
----
...
----
> secrets-mgr:secret-group:describe [flags] <id>
----
...
----
> secrets-mgr:secret-group:modify  [flags] <id> 
----
